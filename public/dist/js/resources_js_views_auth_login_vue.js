              ...
              case 0:
                ...
                axios.post('/login', _this.form).then(function (response) {
                  ...
                  if (response.data.user) {
                    ...
                    _this.$store.dispatch('createUserAuth', response.data.user);

                    _this.$store.dispatch('isLoggedIn', true);
...
var render = function() {
  ...
  return _c(
    ...
    [
                                ...
                                _c(
                                  ...
                                  [
                                    _c("img", {
                                      ...
                                      attrs: {
                                        src: "assets/auth/login-rafiki.png",
                                        width: "100%"
                                      }
                                    })
                                  ]
      ...
      _c(
        "v-overlay",
        { attrs: { value: _vm.overlay, opacity: "1", color: "white" } },
        [
