    ...
    <div>
        <v-main>
            <v-container fluid>
                ...
                <v-row v-else>
                    <v-col lg="8" cols="12" md="8">
                        <form @submit.prevent="updateLeague" enctype="multipart/form-data">
                            <v-card>
...
export default {
    ...
    methods: {
        ...
        updateLeague() {
            ...
            axios.post('/leagues/' + this.$route.params.id, formData).then(() => {
                this.$error = false
        ...
        getLeagueById() {
            ...
            axios.get('leagues/' + this.$route.params.id + '/edit').then(response => {
